...
const TRANSAK_API_KEY_TEST_PROD_CONNECTED =
  process.env.TRANSAK_API_KEY_TEST_PROD_CONNECTED;
const TRANSAK_SECRET_TEST_PROD_CONNECTED =
  process.env.TRANSAK_SECRET_TEST_PROD_CONNECTED;
...
const MERCURYO_WIDGET_ID_TEST = process.env.MERCURYO_WIDGET_ID_TEST;
const MERCURYO_WIDGET_ID_PROD = process.env.MERCURYO_WIDGET_ID_PROD;
